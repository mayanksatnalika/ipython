...
auc2016 = pd.read_csv('s2017.csv')
pnames= []
players = auc2016['fname'] + ' ' + auc2016['sname']
print players[0]
for play in players:
    pnames.append(str(str(play).replace(' ','+')))
...
for player_name in pnames:
    try:
        ...
        fname = 'score_files/2017_t20_' + str(player_name) + '.csv'
        print fname
        print player_name
        ...
        fname = 'score_files/2017_listA_' + str(player_name) + '.csv'
