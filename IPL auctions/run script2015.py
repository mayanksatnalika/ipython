...
auc2015 = pd.read_csv('2015_auctions.csv')
pnames= []
players = auc2015['player_name']
for play in players:
...
for player_name in pnames:
    try:
        ...
        fname = 'score_files/2015_t20_' + str(player_name) + '.csv'
        print fname
        print player_name
        ...
        fname = 'score_files/2015_listA_' + str(player_name) + '.csv'
